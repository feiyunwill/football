...
# 2026-09-09: replace unbounded transport, incomplete handshake and orphaned
# receive threads with the shared bounded TCP client implementation.
...
# 2026-09-09: replace one-snapshot rollback and unverified confirmations
# with bounded whole-frame history, exact sampled input and hash checks.
...
#     # 2026-09-09: a terminal transport failure discards authority. Do not keep
#     # predicting from that incomplete history or allocate another snapshot.
...
#     # Sending or deadline detection can close a previously connected client.
#     if self._client.is_disconnected():
#       self._only_authority_mode = True
#       self._running = False
#       return
...
# 2026-09-10: preserve blocking fresh-session retries; require actual token/snapshot recovery.
