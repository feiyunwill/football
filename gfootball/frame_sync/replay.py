# 2026-09-10: replace mutable, count-only recording with bounded immutable records,
# shared collection admission and complete, verifiable streaming persistence.
# Original implementation is retained below for repository modification policy.
# """
...
from gfootball.frame_sync.replay_store import Replay, ReplayCursor, ReplayManager
from gfootball.frame_sync.replay_file import ReplayFileReader, load_replay, save_replay
