...
# 2026-09-10: preserve legacy unbounded/unordered transport; use bounded
# delivery, common frame validation and one joined IO worker below.
...
# 2026-09-10: replace blocking fresh-session reconnect with bounded token/snapshot recovery.
