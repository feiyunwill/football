# 2026-09-10: retain the old incomplete loop; real authority/replica/save/replay now share an owner.
# #!/usr/bin/env python3
...
from gfootball.frame_sync.local_runtime import LocalPlayer, main
