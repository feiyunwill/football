...
# 2026-09-09: historical description retained below; the Python API supplies
# bounded latest-state publication, not position/pose interpolation.
...
# 2026-09-09: bound immutable snapshot storage, publish atomically and avoid
# repeated restore on every draw. Opaque snapshots are not interpolated.
