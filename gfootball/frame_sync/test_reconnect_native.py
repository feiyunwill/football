...
"""Requires actual native GameEnv. Explicit runner selection, no fallback or skip."""
import unittest
...
class ReconnectNativeTest(unittest.TestCase):
  def test_gameenv_automatic_token_snapshot_handback_and_thirteen_frames(self):
    server = FrameSyncServer('127.0.0.1', 0, left_agents=1, right_agents=0,
